...
def get_retrieval_query(query, label, retrieval_setting):
    if retrieval_setting in ["llm", "given_gt"]:
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        help='given_gt/llm uses query+GT and forces chunk 0 into Top-K; end2end/real uses query-only retrieval and the retriever Top-K directly'
    )
